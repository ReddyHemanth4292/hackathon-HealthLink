    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">HealthLink 
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">HealthLink

                        </h5>
                        <h6 class="animated bounceInDown">Integrated HealthLink: <br>
MocDoc Integrated HealthLink Stores all information and helps to connect all the departments under one single interface. <br> 
Accurate Reporting: <br>
Every report that is generated is maintained and recorded by the system. MocDoc HealthLink system provides accurate reports.
</h6>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_3.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">HealthLink</h5>
                        <h6 class="animated bounceInDown">Time Management: <br>
                        Effective time management helpScheduling patient appointments in advance is one of the main features of our HMIS system. Our system also allows multiple types of appointment creation.s in improving the productivity of the hospital. The MocDoc HMS system plays a vital role in handling time management. <br>
                        Appointment Scheduling:<br>
                        Scheduling patient appointments in advance is one of the main features of our HMIS system. Our system also allows multiple types of appointment creation.
                ...
                <div class="carousel-item inactive">
                    <img class="d-block w-100" src="assets\images\slider\slider4.jpg" alt="Fourth slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">HealthLink</h5>
